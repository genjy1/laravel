...
{{--                    </li>--}}
{{--                    <li class="nav-item">--}}
{{--                        <a class="nav-link active" href="/posts">Посты</a>--}}
{{--                    </li>--}}
{{--                </ul>--}}
    ...
    <header class="bg-white">
        <nav class="mx-auto flex max-w-7xl items-center justify-between" aria-label="Global">
            ...
            <div class="hidden lg:flex lg:gap-x-12">
                <a href="/" class="text-sm font-semibold leading-6 text-gray-900">Создать пост</a>
                <a href="/posts" class="text-sm font-semibold leading-6 text-gray-900">Посты</a>
            </div>
            <div class="hidden lg:flex lg:flex-1 lg:justify-end">
                <form>
                    <div class="flex">
                        <div class="relative w-full">
                            <input type="search" id="search-dropdown" class="block p-2.5 w-full z-20 text-sm text-gray-900 bg-gray-50 rounded border-gray border-s-2 border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-s-gray-700  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-blue-500" placeholder="Поиск постов..." required>
                ...
                <div class="">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-author my-2">Автор: {{$post->name}}</p>
                            <a href="#" class="block text-center max-w-52 bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded">Посмотреть пост</a>
                        </div>
                    </div>
                </div>
            @endforeach
